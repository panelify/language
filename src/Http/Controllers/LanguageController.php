...
namespace Panelify\Language\Http\Controllers;
...
use Panelify\Language\Http\Requests\StoreLanguageRequest;
use Panelify\Language\Http\Requests\UpdateLanguageRequest;
use Throwable;
...
class LanguageController extends Controller
{
    ...
    public function index(string $panel, string $section): View|JsonResponse
    {
        ...
        // Set data language
        $data['name'] = trans('panelify-language::base.name');
        ...
        return view('panelify-language::list', $data);
    }
    ...
    public function create(string $panel, string $section): View
    {
        ...
        DomiTitle(trans('panelify-language::base.form.create.title'));

        // Add breadcrumb
        add_breadcrumb_base($panel, $section);
        Breadcrumb::add($data['name'], $this->route['index']);
        Breadcrumb::add(trans('panelify-language::base.form.create.title'));
        ...
        return view('panelify-language::form', $data);
    }
    ...
    public function store(StoreLanguageRequest $request, string $panel, string $section): RedirectResponse
    {
        ...
        if ($language['ok']) {
            ...
            // btn save
            return redirect()->route('panelify-language.language.edit', [
                'panel' => $panel,
                'section' => $section,
    ...
    public function edit(string $panel, string $section, LanguageModel $language): View
    {
        ...
        DomiTitle(trans('panelify-language::base.form.edit.title'));

        // Add breadcrumb
        add_breadcrumb_base($panel, $section);
        Breadcrumb::add($data['name'], $this->route['index']);
        Breadcrumb::add(trans('panelify-language::base.form.edit.title'));
